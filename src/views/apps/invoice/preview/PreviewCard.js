...
import Logo from '../../../../assets/images/logo/gmoney.ico'
        ...
        <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
          <div>
            <div className='logo-wrapper'>
              ...
              <h3 className='text-primary invoice-logo'>Gmoney</h3>
            </div>
          ...
          <div className='mt-md-0 mt-2'>
            ...
            <div className='invoice-date-wrapper'>
              <p className='invoice-date-title'>Inv Date:</p>
              <p className='invoice-date'>{data.invoice.invoice_date}</p>
            </div>
            <div className='invoice-date-wrapper'>
              <p className='invoice-date-title'>Inv Uploaded Date:</p>
              <p className='invoice-date'>{data.invoice.upload_date}</p>
            </div>
          </div>
        </div>
        {/* /Header */}
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row className='invoice-spacing'>
          <Col className='p-0' xl='8'>
            ...
            <h6 className='mb-25'>{data.invoice.hsp_name}</h6>
            {/* <CardText className='mb-25'>{data.invoice.hsp_name}</CardText> */}
            <CardText className='mb-25'>{data.invoice.mobile_number}</CardText>
